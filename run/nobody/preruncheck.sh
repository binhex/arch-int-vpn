...
# blocking script, will wait for name resolution to be operational (ip address from resolved host read in from file /tmp/getdns)
# value read in is generated by script /root/getdns.sh
