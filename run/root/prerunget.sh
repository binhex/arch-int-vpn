...
# blocking script, will wait for name resolution to be operational (ip address from resolved host written to file /tmp/getdns)
source /root/getdns.sh "www.google.com"
